...
$sql = "SELECT * FROM `$wp_content_calendar`;";
...
<div class="wrap">
    ...
    <form id="posts-filter" method="get">
        ...
        <p class="search-box">
            <label class="screen-reader-text" for="content-search-input">Search Content:</label>
            <input type="search" id="content-search-input" name="s" value="">
            <input type="submit" id="search-submit" class="button" value="Search Content">
        </p>
        ...
        <input type="hidden" id="_wpnonce" name="_wpnonce" value="4df19c043d"><input type="hidden" name="_wp_http_referer" value="/wp-admin/edit.php">
        ...
        <table class="wp-list-table widefat fixed striped table-view-list posts">
            <thead>
                <tr>
                    ...
                    <th scope="col" id="post-title" class="manage-column column-post-title column-primary">
            ...
            <tbody id="the-list">
                ...
                ?>
                <!-- <tr id="post-1">
                    <td class="title column-post-title has-row-actions column-primary page-title"
                        data-colname="Post Title">
                        <strong>Hello world</strong>
                    </td>
                    <td class="categories column-occassion" data-colname="Occassion">Occasion</td>
                    <td class="author column-author" data-colname="Author">admin</td>
                    <td class="tags column-reviewer" data-colname="Reviewer">Reviewer</td>
                    <td class="date column-date" data-colname="Date">2023/04/10</td>
                </tr> -->
            </tbody>
